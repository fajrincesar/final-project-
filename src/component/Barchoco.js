...
class Barchoco extends Component {
    constructor(){
        super();
        this.state={
            prd:[]
    ...
    componentDidMount(){
        axios.get('http://localhost:7000/data/cup')
        .then((getdata)=>{
    ...
    render() {
                         ...
                         <div className="card h-100" id="card-item">
                            <a href="#"><img className="card-img-top" src={img} alt="item-shop2" style={{width:"265px", height:"265px"}}></img></a>
                                <div className="card-body" style={{padding:"5px"}}>
                                    ...
                                    <p className="card-text" id="titlecard"></p>
      ...
      return (
        <div>
            <div className="fluid-container" style={{marginTop:"70px", marginLeft:"20px"}}>
                <div className="row">   
